import { ModalBuilder, TextInputBuilder, TextInputStyle, ActionRowBuilder, StringSelectMenuBuilder, ButtonStyle } from 'discord.js';
import { Ticket, StaffActions, CategoryConfig } from '../models/ticketModels.js';
import { closeTicket, deleteTicket } from './ticketClosure.js';
import { createTicket } from './ticketCreation.js';
import { addUserToTicket, removeUserFromTicket, setTicketPermissions } from './permissionManager.js';
